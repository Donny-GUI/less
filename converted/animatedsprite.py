class AnimatedSprite(Sprite):
    ...
    def reset(self):
        self.atlas = G.ANIMATION_ATLAS[self.atlas.name]self.set_sprite_pos()
    ...
    def set_sprite_pos(self, sprite_pos):
        ...
        G.ANIMATION_ATLAS[self.atlas.name] = self.atlas.image.getDimensions()
    ...
    def get_pos_pixel(self):
        ...
        G.ANIMATION_ATLAS[self.atlas.name] = self.current_animation.current
        G.ANIMATION_ATLAS[self.atlas.name] = self.animation.y
        G.ANIMATION_ATLAS[self.atlas.name] = self.animation.w
        G.ANIMATION_ATLAS[self.atlas.name] = self.animation.h
