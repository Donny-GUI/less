class Node(object):
    ...
    def __init__(self, args):
        ...
        self.T = {args.T[x': (args.T.x if args.T.x else '1[args.T]') if (args.T.x if args.T.x else '1[args.T]') else 0, 'y': (args.T.y if args.T.y else '2[args.T]') if (args.T.y if args.T.y else '2[args.T]') else 0, 'w': (args.T.w if args.T.w else '3[args.T]') if (args.T.w if args.T.w else '3[args.T]') else 1, 'h': (args.T.h if args.T.h else '4[args.T]') if (args.T.h if args.T.h else '4[args.T]') else 1, 'r': (args.T.r if args.T.r else '5[args.T]') if (args.T.r if args.T.r else '5[args.T]') else 0, 'scale': (args.T.scale if args.T.scale else '6[args.T]') if (args.T.scale if args.T.scale else '6]) else 1}
        self.CT = self.T
