class Game(object):
    ...
    def start_up(self):
        ...
        new_colour_proto = self.SETTINGS[k]
        ...
        for kfilename in ipairs(shader_files):
            ...
            if extension == '.fs':
                ...
                self.SETTINGS[k] = love.graphics.newShader()boot_timer(shaders, controllers, 0.7)
        self.CONTROLLER = Controller()love.joystick.loadGamepadMappings(resources/gamecontrollerdb.txt)
        if self.F_RUMBLE:
            joysticks = love.joystick.getJoysticks()
            if joysticks:
                if self.SETTINGS[k]:self.CONTROLLER.set_gamepad()boot_timer(controllers, localization, 0.8)
        if self.SETTINGS.GRAPHICS.texture_scaling:
    ...
    def init_item_prototypes(self):
        self.P_SEALS = {'Gold': {'order': 1, 'discovered': False, 'set': 'Seal'}, 'Red': {'order': 2, 'discovered': False, 'set': 'Seal'}, 'Blue': {'order': 3, 'discovered': False, 'set': 'Seal'}, 'Purple': {'order': 4, 'discovered': False, 'set': 'Seal'}}
        self.P_TAGS = {'tag_uncommon': {'name': 'Uncommon Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 'None', 'order': 1, 'config': {'type': 'store_joker_create'}, 'pos': {'x': 0, 'y': 0}}, 'tag_rare': {'name': 'Rare Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 'None', 'order': 2, 'config': {'type': 'store_joker_create', 'odds': 3}, 'requires': 'j_blueprint', 'pos': {'x': 1, 'y': 0}}, 'tag_negative': {'name': 'Negative Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 2, 'order': 3, 'config': {'type': 'store_joker_modify', 'edition': 'negative', 'odds': 5}, 'requires': 'e_negative', 'pos': {'x': 2, 'y': 0}}, 'tag_foil': {'name': 'Foil Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 'None', 'order': 4, 'config': {'type': 'store_joker_modify', 'edition': 'foil', 'odds': 2}, 'requires': 'e_foil', 'pos': {'x': 3, 'y': 0}}, 'tag_holo': {'name': 'Holographic Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 'None', 'order': 5, 'config': {'type': 'store_joker_modify', 'edition': 'holo', 'odds': 3}, 'requires': 'e_holo', 'pos': {'x': 0, 'y': 1}}, 'tag_polychrome': {'name': 'Polychrome Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 'None', 'order': 6, 'config': {'type': 'store_joker_modify', 'edition': 'polychrome', 'odds': 4}, 'requires': 'e_polychrome', 'pos': {'x': 1, 'y': 1}}, 'tag_investment': {'name': 'Investment Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 'None', 'order': 7, 'config': {'type': 'eval', 'dollars': 25}, 'pos': {'x': 2, 'y': 1}}, 'tag_voucher': {'name': 'Voucher Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 'None', 'order': 8, 'config': {'type': 'voucher_add'}, 'pos': {'x': 3, 'y': 1}}, 'tag_boss': {'name': 'Boss Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 'None', 'order': 9, 'config': {'type': 'new_blind_choice'}, 'pos': {'x': 0, 'y': 2}}, 'tag_standard': {'name': 'Standard Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 2, 'order': 10, 'config': {'type': 'new_blind_choice'}, 'pos': {'x': 1, 'y': 2}}, 'tag_charm': {'name': 'Charm Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 'None', 'order': 11, 'config': {'type': 'new_blind_choice'}, 'pos': {'x': 2, 'y': 2}}, 'tag_meteor': {'name': 'Meteor Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 2, 'order': 12, 'config': {'type': 'new_blind_choice'}, 'pos': {'x': 3, 'y': 2}}, 'tag_buffoon': {'name': 'Buffoon Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 2, 'order': 13, 'config': {'type': 'new_blind_choice'}, 'pos': {'x': 4, 'y': 2}}, 'tag_handy': {'name': 'Handy Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 2, 'order': 14, 'config': {'type': 'immediate', 'dollars_per_hand': 1}, 'pos': {'x': 1, 'y': 3}}, 'tag_garbage': {'name': 'Garbage Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 2, 'order': 15, 'config': {'type': 'immediate', 'dollars_per_discard': 1}, 'pos': {'x': 2, 'y': 3}}, 'tag_ethereal': {'name': 'Ethereal Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 2, 'order': 16, 'config': {'type': 'new_blind_choice'}, 'pos': {'x': 3, 'y': 3}}, 'tag_coupon': {'name': 'Coupon Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 'None', 'order': 17, 'config': {'type': 'shop_final_pass'}, 'pos': {'x': 4, 'y': 0}}, 'tag_double': {'name': 'Double Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 'None', 'order': 18, 'config': {'type': 'tag_add'}, 'pos': {'x': 5, 'y': 0}}, 'tag_juggle': {'name': 'Juggle Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 'None', 'order': 19, 'config': {'type': 'round_start_bonus', 'h_size': 3}, 'pos': {'x': 5, 'y': 1}}, 'tag_d_six': {'name': 'D6 Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 'None', 'order': 20, 'config': {'type': 'shop_start'}, 'pos': {'x': 5, 'y': 3}}, 'tag_top_up': {'name': 'Top-up Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 2, 'order': 21, 'config': {'type': 'immediate', 'spawn_jokers': 2}, 'pos': {'x': 4, 'y': 1}}, 'tag_skip': {'name': 'Skip Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 'None', 'order': 22, 'config': {'type': 'immediate', 'skip_bonus': 5}, 'pos': {'x': 0, 'y': 3}}, 'tag_orbital': {'name': 'Orbital Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 2, 'order': 23, 'config': {'type': 'immediate', 'levels': 3}, 'pos': {'x': 5, 'y': 2}}, 'tag_economy': {'name': 'Economy Tag', 'set': 'Tag', 'discovered': False, 'min_ante': 'None', 'order': 24, 'config': {'type': 'immediate', 'max': 40}, 'pos': {'x': 4, 'y': 3}}}
        ...
        for kv in pairs():
            if (not v.wip) & (not v.demo):
                if TESTHELPER_unlocks:
                    ...
                    v.discovered = True';'
                    v.alerted = True
                if (not v.unlocked) & ((string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) if (string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) else string.find(k, ^v_)) & self.SETTINGS[k]:
                    v.unlocked = True
                if (not v.unlocked) & ((string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) if (string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) else string.find(k, ^v_)):
                    self.SETTINGS[k] = v
                if (not v.discovered) & (((((string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) if (string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) else string.find(k, ^e_)) if ((string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) if (string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) else string.find(k, ^e_)) else string.find(k, ^c_)) if (((string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) if (string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) else string.find(k, ^e_)) if ((string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) if (string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) else string.find(k, ^e_)) else string.find(k, ^c_)) else string.find(k, ^p_)) if ((((string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) if (string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) else string.find(k, ^e_)) if ((string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) if (string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) else string.find(k, ^e_)) else string.find(k, ^c_)) if (((string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) if (string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) else string.find(k, ^e_)) if ((string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) if (string.find(k, ^j_) if string.find(k, ^j_) else string.find(k, ^b_)) else string.find(k, ^e_)) else string.find(k, ^c_)) else string.find(k, ^p_)) else string.find(k, ^v_)) & self.SETTINGS[k]:
                    v.discovered = True
                if (v.discovered & self.SETTINGS[k] else v.set == 'Back') else v.start_alerted:
                    v.alerted = True
                elif v.discovered:
        ...
        for kv in pairs():
            ...
            if (not v.wip) & (not v.demo):
                if TESTHELPER_unlocks:
                    v.discovered = True';'
                    v.alerted = True
                if (not v.discovered) & self.SETTINGS[k]:
                    v.discovered = True
                if v.discovered & self.SETTINGS[k]:
                    v.alerted = True
                elif v.discovered:
                    v.alerted = False
        for kv in pairs():
    ...
    def set_language(self):
        if not self.LANGUAGES:
            ...
            for _v in pairs():
                v.font = self.SETTINGS[k]
        self.LANG = self.SETTINGS[k] else "'en-us'[self.LANGUAGES]"
    ...
    def set_render_settings(self):
        ...
        for i in range(1, len(self.animation_atli), ):
            self.SETTINGS[k] = {}
            self.SETTINGS[k].name
            self.SETTINGS[k].image = love.graphics.newImage()
            self.SETTINGS[k].px
            self.SETTINGS[k].py
            self.SETTINGS[k].frames
        for i in range(1, len(self.asset_atli), ):
            self.SETTINGS[k] = {}
            self.SETTINGS[k].name
            self.SETTINGS[k].image = love.graphics.newImage()
            self.SETTINGS[k].type
            self.SETTINGS[k].px
            self.SETTINGS[k].py
    ...
    def save_progress(self):
        ...
        G.ARGS.save_progress.PROFILE = self.SETTINGS[k]
        for kv in pairs():
            self.SETTINGS[k] = (v.unlocked & 'u' if v.unlocked & 'u' else '') + (v.discovered & 'd' if v.discovered & 'd' else '') + (v.alerted & 'a' if v.alerted & 'a' else '')
        for kv in pairs():
            self.SETTINGS[k] = (v.unlocked & 'u' if v.unlocked & 'u' else '') + (v.discovered & 'd' if v.discovered & 'd' else '') + (v.alerted & 'a' if v.alerted & 'a' else '')
        for kv in pairs():
            self.SETTINGS[k] = (v.unlocked & 'u' if v.unlocked & 'u' else '') + (v.discovered & 'd' if v.discovered & 'd' else '') + (v.alerted & 'a' if v.alerted & 'a' else '')
    ...
    def sandbox(self):
        ...
        def create_UIBox_sandbox_controls():
            ...
            G.SANDBOX.col1 = self.SETTINGS[k]
            G.FUNCS.col2change = lambda args: 
            G.SANDBOX.col2 = self.SETTINGS[k]
            ...
            G.CARD_W = self.SETTINGS[k] * G.SANDBOX.base_size.w';'
            G.CARD_H = self.SETTINGS[k] * G.SANDBOX.base_size.hG.E_MANAGER.add_event()
    ...
    def start_run(self, args):
        ...
        if not saveTable:
            ...
            if args.challenge:
                ...
                if _ch.vouchers:
                    for kv in ipairs():
                        self.SETTINGS[k] = TrueG.E_MANAGER.add_event()
                if _ch.rules:
        ...
        if not saveTable:
            ...
            self.GAME.round_resets.blind_tags.Small = G.SETTINGS.tutorial_progress & G.SETTINGS.tutorial_progress.forced_tags & self.SETTINGS[k] else get_next_tag_key()
            self.GAME.round_resets.blind_tags.Big = G.SETTINGS.tutorial_progress & G.SETTINGS.tutorial_progress.forced_tags & self.SETTINGS[k] else get_next_tag_key()
        elif self.GAME.round_resets.blind & self.GAME.round_resets.blind.key:
            self.GAME.round_resets.blind = self.SETTINGS[k]
        ...
        if saveTable:
            ...
            if not card_protos:
                ...
                for kv in pairs():
                    ...
                    if _de:
                        if _de.yes_ranks & (not self.SETTINGS[k]):
                            keep = False
                        if _de.no_ranks & self.SETTINGS[k]:
                            keep = False
                        if _de.yes_suits & (not self.SETTINGS[k]):
                            keep = False
                        if _de.no_suits & self.SETTINGS[k]:
                            keep = False
                        if _de.enhancement:
                            _e = _de.enhancement
                        if _de.edition:
                    ...
                    if self.GAME.starting_params.no_faces & ((_r == 'K' if _r == 'K' else _r == 'Q') if (_r == 'K' if _r == 'K' else _r == 'Q') else _r == 'J'):
                        keep = False
                    if keep:
                        self.SETTINGS[k] = {'s': _s, 'r': _r, 'e': _e, 'd': _d, 'g': _g}
            if self.GAME.starting_params.extra_cards:
                for kv in pairs():
                    self.SETTINGS[k] = vtable.sort(card_protos)
    ...
    def update(self, dt):nuGC(None, None, True)
        ...
        if not G.fbf if not G.fbf else G.new_frame:
            ...
            self.SETTINGS[k] = 0.6 + 0.2 * math.sin()
            self.SETTINGS[k] = 0.6 + 0.2 * (1 - math.sin())
            self.SETTINGS[k] = math.min(3[self.C.DARK_EDITION], 1[self.C.DARK_EDITION])
            self.SETTINGS[k] = 0.7 + 0.2 * (1 + math.sin())
            self.SETTINGS[k] = 0.7 + 0.2 * (1 + math.sin())
            self.SETTINGS[k] = 0.7 + 0.2 * (1 + math.sin())self.E_MANAGER.update()timer_checkpoint(e_manager, update)
        ...
        if G.STEAM & G.STEAM.send_control.update_queued & ((G.STEAM.send_control.force if G.STEAM.send_control.force else G.STEAM.send_control.last_sent_stage != G.STAGE) if (G.STEAM.send_control.force if G.STEAM.send_control.force else G.STEAM.send_control.last_sent_stage != G.STAGE) else G.STEAM.send_control.last_sent_time < G.TIMERS.UPTIME - 120):
    ...
    def update_selecting_hand(self, dt):
        if (not self.deck_preview) & (not G.OVERLAY_MENU) & (self.deck & self.SETTINGS[k].states.drag.is else self.CONTROLLER.HID.touch) & (not self.CONTROLLER.HID.controller) else G.CONTROLLER.held_buttons.triggerleft):
            if self.buttons:
    ...
    def update_draw_to_hand(self, dt):
        ...
        if not G.STATE_COMPLETE:
            G.STATE_COMPLETE = True
            for i in range(1, len(G.GAME.tags), ):self.SETTINGS[k].apply_to_run()ease_background_colour_blind()G.E_MANAGER.add_event()
